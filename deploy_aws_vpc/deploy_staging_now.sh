...
ansible-playbook -i ./etc/ansible/hosts  ./vpc.yml --vault-password-file ../env/ansibled-staging.vault --extra-vars "vpc_env=staging vpc_base_region=us-east vpc_number=1 aws_region=us-east-1 ansible_python_interpreter=/mgmt-ctrl/cdex-deploy/env/bin/python3"  -v
