...
ansible-playbook -i ./etc/ansible/hosts  ./deploy_server.yml --vault-id ./env/ansibled.vault --extra-vars "vpc_env=staging vpc_base_region=us-east vpc_number=1 aws_region=us-east-1"  -v
