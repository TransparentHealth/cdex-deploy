...
ansible-playbook -i ./etc/ansible/hosts  ./deploy_target_group.yml --vault-id ~/ansibled.vault --extra-vars "vpc_env=prod vpc_base_region=us-east vpc_number=1 aws_region=us-east-1"  -v
